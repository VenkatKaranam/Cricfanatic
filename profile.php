...
<body>
		...
		<center><div class="profile">
			<div class="profilepic">
				...
				<center><button id="button2"><a href="upd.php">Update Picture</a></button></center>
...
<center><button id="button" style="color: white;"><a href="logout.php">Logout</a></button></center><br>
